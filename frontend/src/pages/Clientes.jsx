    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-slate-400 mt-0.5">Gerencie sua base de clientes</p>
        </div>
              ...
              <Card key={c.id}>
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    <p className="font-semibold text-gray-900 truncate dark:text-slate-100">{c.nome_razao_social}</p>
                ...
                <div className="mt-3 grid grid-cols-2 gap-x-3 gap-y-1.5 text-xs text-gray-600 dark:text-slate-400">
                  ...
                  {c.telefone && (
                    <div>
                      ...
                      <p className="font-medium text-gray-800 dark:text-slate-200">{c.telefone}</p>
                    </div>
                  )}
                  {c.email && (
                    <div className="col-span-2">
                      <span className="text-gray-400 dark:text-slate-500">E-mail</span>
                      <p className="font-medium text-gray-800 truncate dark:text-slate-200">{c.email}</p>
                    </div>
                  )}
                </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200 dark:bg-navy-900 dark:border-navy-600">
                      ...
                      <th className="text-left px-4 py-3 font-semibold text-gray-600 whitespace-nowrap dark:text-slate-400">Segmento</th>
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-navy-700">
                    {clientes.map((c) => (
                      <tr key={c.id} className="hover:bg-gray-50 dark:hover:bg-navy-700/60 transition-colors">
                        ...
                        <td className="px-4 py-3 text-gray-600 whitespace-nowrap dark:text-slate-400">{c.documento || '—'}</td>
                        ...
                        <td className="px-4 py-3 text-gray-600 whitespace-nowrap dark:text-slate-400">
                          <div>{c.telefone || '—'}</div>
                          {c.email && (
                            <div className="text-xs text-gray-400 truncate max-w-[160px] dark:text-slate-500">{c.email}</div>
                          )}
                        </td>

...
export default function Administrativo() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-slate-100">Administrativo</h1>
        <p className="text-sm text-gray-500 mt-0.5 dark:text-slate-400">Documentos, contratos e processos internos</p>
      </div>

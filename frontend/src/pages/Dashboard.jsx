  ...
  if (erro) {
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-12 text-red-600 text-sm">{erro}</div>
      </div>
    )
  }
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-100 text-left">
                  <th className="px-6 py-3 font-semibold text-gray-700">Mês</th>
                  <th className="px-4 py-3 font-semibold text-gray-700 text-right">Receita</th>
                  <th className="px-4 py-3 font-semibold text-gray-700 text-right">Despesa</th>
                  <th className="px-6 py-3 font-semibold text-gray-700 text-right">Resultado</th>
                </tr>
              </thead>
                ...
                {grafico.map((row) => {
                  ...
                  return (
                    <tr key={row.mes} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-right text-accent-600">{formatCurrency(row.receita)}</td>
                      <td className="px-4 py-3 text-right text-red-600">{formatCurrency(row.despesa)}</td>
                      <td className={`px-6 py-3 text-right font-semibold ${resultado >= 0 ? 'text-green-700' : 'text-red-600'}`}>
